# -*- coding: utf-8 -*-
"""fork-of-fork-of-notebook228c511a12.ipynb

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/1dqjTW8Y1FdioZckyPYh4LSKooil6i3y6
"""
...
df = pd.read_csv("/kaggle/input/rstp-reid2/caption.csv")
...
class CFG:
    debug = False
    image_path = "/kaggle/input/rstp-reid2/imgs"
    captions_path = "/kaggle/input/rstp-reid2/caption.csv"
    ...
    # Model selection
    model_name = "mobilenet_v3_large"  # EfficientNet-B3 for better accuracy vs. compute balance
    image_embedding = 960  # EfficientNet-B3 feature dimension
...
class ImageEncoder(nn.Module):
    """
    MobileNetV3 Large based Image Encoder (output: 960 features)
    """
    ...
    def __init__(
        ...
        super().__init__()
        mobilenet = torch.hub.load('pytorch/vision:v0.10.0', 'mobilenet_v3_large', pretrained=pretrained)

        # Remove classifier, retain features
        self.model = mobilenet.features  # Feature extractor
        self.pool = nn.AdaptiveAvgPool2d((1, 1))  # Pooling layer to get (B, 960, 1, 1) -> (B, 960)
    ...
    def forward(self, x):
        x = self.model(x)             # Shape: (B, 960, H, W)
        x = self.pool(x)              # Shape: (B, 960, 1, 1)
