# -*- coding: utf-8 -*-
"""fork-of-notebook228c511a12.ipynb

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/1SKmObp--_IbTJGuZyTQUdbbxM6NnGJYx
...
class ImageEncoder(nn.Module):
    def __init__(self, embed_dim=cfg.image_embedding):
        ...
        mobilenet = torch.hub.load('pytorch/vision:v0.10.0', 'mobilenet_v3_large', pretrained=cfg.pretrained)
        self.features = mobilenet.features
        self.attnpool = AttentionPool2d(spacial_dim=7, embed_dim=960, num_heads=8, output_dim=embed_dim)
        std = 1280 ** -0.5
