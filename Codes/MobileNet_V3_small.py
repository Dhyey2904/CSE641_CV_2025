...
Original file is located at
    https://colab.research.google.com/drive/1lp0LBrX6Vji_auV71bsGGgTowC-dY_3o
...
class CFG:
    debug = False
    image_path = "/kaggle/input/dataset/imgs"
    captions_path = "/kaggle/input/caption"
    batch_size = 128
    num_workers = 4
    head_lr = 1e-3
...
class ImageEncoder(nn.Module):
    def __init__(self, embed_dim=cfg.image_embedding):
        ...
        mobilenet = torch.hub.load('pytorch/vision:v0.10.0', 'mobilenet_v3_small', pretrained=cfg.pretrained)
        self.features = mobilenet.features
        self.attnpool = AttentionPool2d(spacial_dim=7, embed_dim=576, num_heads=8, output_dim=embed_dim)
        std = 1280 ** -0.5
...
def make_train_valid_dfs():
    dataframe = pd.read_csv(f"{cfg.captions_path}/caption.csv")
...
model.load_state_dict(torch.load("/kaggle/input/new/pytorch/default/1/best(6).pt", map_location=device))  # Load state_dict
