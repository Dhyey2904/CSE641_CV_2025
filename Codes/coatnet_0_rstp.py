# -*- coding: utf-8 -*-
"""coatnet-0-rstp.ipynb

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/1lxasIvEjLs4EXXpBiWJig41Z8Tgp48D5
"""
...
df = pd.read_csv("/kaggle/input/rstp-csv/reformatted_captions (1).csv")
...
class CFG:
    debug = False
    image_path = "/kaggle/input/rstpreid-2/RSTPReid/imgs"
...
model.load_state_dict(torch.load("/kaggle/input/coatnet-rstp/best_coatnet0_rstp.pt", map_location=device))
model.eval()
...
model, image_embeddings = get_image_embeddings(valid_df, "/kaggle/input/coatnet-rstp/best_coatnet0_rstp.pt")
